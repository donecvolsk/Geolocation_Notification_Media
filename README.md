...
### Повышенный уровень сложности (не обязательно). Аудио-записи с координатами*
...
### Повышенный уровень сложности (не обязательно). Видео-записи с координатами* (задача со звёздочкой)
